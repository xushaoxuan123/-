...
from dataset.flickr8k_dataset import Flickr8k
...
def train(args):
    ...
    print("######################## Training on dataset: {} ########################".format(dataset_config['name']))
    ...
    if os.path.exists(os.path.join(train_config['task_name'],
        ...
        print('Loading U-Net checkpoint for diffusion training')
        model.load_state_dict(torch.load(os.path.join(train_config['task_name'],
                                                      train_config['ldm_ckpt_name']),
                                         map_location=device))
    model.train()
    print("######################## Diffusion backbone created ########################")
    vae = None
